package com.gxut.ui.commonui.steps;
...
public class HorizontalStepsView extends View {
    ...
    public HorizontalStepsView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        surface.stepRadius = (int) a.getDimension(R.styleable.HorizontalStepsView_step_radius, dip2px(context, 9));
        surface.lineSize = a.getDimension(R.styleable.HorizontalStepsView_line_size, dip2px(context, 3));
        surface.textSize = a.getDimension(R.styleable.HorizontalStepsView_text_size, dip2px(context, 11));
        ...
        a.recycle();
        surface.currentStepRadius = surface.stepRadius + dip2px(context, 5);
        surface.init();
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (heightMode == MeasureSpec.EXACTLY)
            ...
            bgHeight = dip2px(getContext(), 80);
        //获取到显示的宽高
        surface.startX = padding + surface.stepRadius;
        setXaxis();
        surface.lineY = Math.min(surface.currentStepRadius + dip2px(getContext(), 5), bgHeight / 2);
    }
